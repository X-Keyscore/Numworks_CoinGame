...
release="2.0"
color={"background":color(0,0,0),"title":color(255,191,0),"text":color(108,52,131),"text-active":color(64,224,208),"player":color(64,224,208),"enemy":color(255,87,34),"platform":color(108,52,131),"coin":color(255,255,0)}
levels=[{"name":"Pyramid","platform":[{"x":1,"y":12,"width":4},{"x":6,"y":12,"width":4},{"x":11,"y":12,"width":4},{"x":16,"y":12,"width":4},{"x":4,"y":10,"width":3},{"x":9,"y":10,"width":3},{"x":14,"y":10,"width":3},{"x":6,"y":8,"width":4},{"x":11,"y":8,"width":4},{"x":9,"y":6,"width":3}],"enemy":[{"x":9,"y":11,"move":-3},{"x":14,"y":9,"move":2},{"x":9,"y":7,"move":-2}],"coin":[{"x":1,"y":11},{"x":6,"y":11},{"x":14,"y":11},{"x":19,"y":11},{"x":4,"y":9},{"x":10,"y":9},{"x":16,"y":9},{"x":6,"y":7},{"x":14,"y":7},{"x":10,"y":5}]},{"name":"Pyramid reverse","platform":[{"x":9,"y":12,"width":3},{"x":6,"y":10,"width":4},{"x":11,"y":10,"width":4},{"x":4,"y":8,"width":3},{"x":9,"y":8,"width":3},{"x":14,"y":8,"width":3},{"x":1,"y":6,"width":4},{"x":6,"y":6,"width":4},{"x":11,"y":6,"width":4},{"x":16,"y":6,"width":4}],"enemy":[{"x":9,"y":11,"move":-3},{"x":14,"y":9,"move":2},{"x":9,"y":7,"move":-2}],"coin":[{"x":10,"y":13},{"x":6,"y":11},{"x":14,"y":11},{"x":4,"y":9},{"x":10,"y":9},{"x":16,"y":9},{"x":1,"y":7},{"x":6,"y":7},{"x":14,"y":7},{"x":19,"y":7}]},{"name":"flower","platform":[{"x":8,"y":12,"width":2},{"x":11,"y":12,"width":2},{"x":5,"y":10,"width":1},{"x":7,"y":10,"width":7},{"x":15,"y":10,"width":1},{"x":6,"y":8,"width":2},{"x":9,"y":8,"width":3},{"x":13,"y":8,"width":2},{"x":8,"y":6,"width":1},{"x":10,"y":6,"width":1},{"x":12,"y":6,"width":1},{"x":10,"y":4,"width":1}],"enemy":[{"x":9,"y":11,"move":-1},{"x":11,"y":11,"move":1},{"x":8,"y":9,"move":4},{"x":11,"y":7,"move":-2}],"coin":[{"x":8,"y":11},{"x":12,"y":11},{"x":5,"y":9},{"x":15,"y":9},{"x":6,"y":7},{"x":14,"y":7},{"x":8,"y":5},{"x":12,"y":5},{"x":10,"y":3}]},{"name":"Space Invaders","platform":[{"x":7,"y":12,"width":1},{"x":13,"y":12,"width":1},{"x":7,"y":10,"width":7},{"x":5,"y":8,"width":4},{"x":12,"y":8,"width":4},{"x":5,"y":6,"width":1},{"x":8,"y":6,"width":5},{"x":15,"y":6,"width":1},{"x":8,"y":4,"width":1},{"x":12,"y":4,"width":1}],"enemy":[{"x":9,"y":9,"move":-2},{"x":11,"y":9,"move":2},{"x":5,"y":7,"move":3},{"x":15,"y":7,"move":-3},{"x":8,"y":5,"move":4}],"coin":[{"x":7,"y":11},{"x":13,"y":11},{"x":8,"y":9},{"x":12,"y":9},{"x":5,"y":5},{"x":10,"y":5},{"x":15,"y":5},{"x":8,"y":3},{"x":12,"y":3}]}]
def waiting():
 sleep(0.15)
def conv(a):
 return a*15
def game(levelId):
 ...
 var={"player":{"x":0,"y":13},"enemyTime":monotonic(),"enemy":[],"coin":[]}
 ...
 def enemyMove(color,level,var):
  ...
  if((var['enemyTime']+1)<monotonic()):
   ...
   time=var['enemyTime']
   enemy=var['enemy']
  return{"player":var['player'],"enemyTime":time,"enemy":enemy,"coin":var['coin']}
 def touchEnemy(var):
  for varEnemy in var['enemy']:
